...
$new = R::load('groups',$_POST["groupid"]);
$new->name = $group;
...
header("Location: manage-groups.php?edit=1");
die();
}
...
<div class="container">
  ...
  <div class="panel-body">
						<div class="row">
							...
							<h3>Edit Group</h3>
								<form id="login-form" action="editgroup.php?id=<?php echo $id; ?>" method="post" role="form" style="display: block;">
									<div class="form-group">
					<input type="text" name="group" id="course" tabindex="1" class="form-control" value="<?php echo $det->name; ?>">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											...
											<input type="hidden" name="groupid" value="<?php echo $det->id; ?>">
												<input type="submit" name="course-enter" id="course-submit" tabindex="4" class="form-control btn btn-login btn-primary" value="Edit Group">
											</div>
										</div>
									</div>
